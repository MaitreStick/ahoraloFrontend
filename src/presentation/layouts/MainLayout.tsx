...
export const MainLayout = ({
  ...
  return (
    <SafeAreaView
      style={stylesMainLayout.safeArea}
      edges={['top', 'left', 'right']}
    >
      <View
        style={[
          stylesMainLayout.backgroundWhite,
          {height: insets.top + topNavigationHeight},
        ]}
      />
      ...
      <Layout style={stylesMainLayout.content}>{children}</Layout>
    </SafeAreaView>
  );
};
