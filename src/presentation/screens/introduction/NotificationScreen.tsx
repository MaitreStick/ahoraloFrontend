...
interface Props extends StackScreenProps<RootStackParams, 'NotificationScreen'> { }

export const NotificationScreen = ({ navigation }: Props) => {

  const { width, height } = useWindowDimensions();
  const setHasCompletedOnboarding = useOnboardingStore((state: any) => state.setHasCompletedOnboarding);
